...
public class CouchBaseConfig {
     ...
     */
    public void getStartedOnline(String scopeName,String colletionName) throws CouchbaseLiteException, URISyntaxException {
        // One-off initialization
        CouchbaseLite.init();
        System.out.println("CBL Initialized");
        // Create a database
        ...
        // Create a new collection (like a SQL table) in the database.
        Collection collection = database.createCollection(colletionName, scopeName);
        System.out.println("Collection created: " + collection);
    }
